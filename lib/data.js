...
export const creditBenefits = [
  ...
  "Credits <strong class='text-emerald-600'>never expire</strong> - use them whenever you need",
  "Monthly subscriptions give you <strong class='text-emerald-600'>fresh credits every month</strong>",
  "Cancel or change your subscription <strong class='text-emerald-600'>anytime</strong> without penalties",
];
